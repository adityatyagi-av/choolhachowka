    ...
    <div className="container px-6 py-12 mx-auto">
        ...
        <div className="grid grid-cols-1 gap-12 mt-10 lg:grid-cols-3 sm:grid-cols-2 ">
            <div className="p-4 rounded-lg bg-yellow-50 md:p-6 ">
                <span className="inline-block p-3 text-yellow-500 rounded-lg bg-yellow-100/80">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-5 h-5">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 01-2.25 2.25h-15a2.25 2.25 0 01-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25m19.5 0v.243a2.25 2.25 0 01-1.07 1.916l-7.5 4.615a2.25 2.25 0 01-2.36 0L3.32 8.91a2.25 2.25 0 01-1.07-1.916V6.75" />
                    </svg>
                </span>

                <h2 className="mt-4 text-base font-medium text-gray-800 ">Whatsapp to enquire</h2>
                <p className="mt-2 text-sm text-gray-500 ">Speak to our friendly team.</p>
                <p className="mt-2 text-sm text-yellow-500 ">choolhachowka@gmail.com</p>
            </div>
            ...
            <div className="p-4 rounded-lg bg-yellow-50 md:p-6">
                ...
                <p className="mt-2 text-sm text-gray-500 ">Visit our mess..</p>
                <p className="mt-2 text-sm text-yellow-500">Shivam Vihar Phase 1, Muradnagar</p>
            </div>
            ...
            <div className="p-4 rounded-lg bg-yellow-50 md:p-6 ">
                ...
                <p className="mt-2 text-sm text-gray-500 ">Mon-Sat from 8am to 8pm.</p>
                <p className="mt-2 text-sm text-yellow-500 ">+91 8000008000</p>
            </div>
        </div>
    </div>
</section>
