...
const Footer = () => {
  ...
  <div class="px-5 gap-x-20 flex-col lg:flex lg:flex-row lg:justify-evenly sm:grid sm:grid-cols-4 sm:gap-4 sm:mb-8 mb-4 sm:ml-3 lg:ml-0 ml-4 mt-2">
    <div class="lg:w-1/3 lg:pe-8 sm:col-start-1 col-span-2">
      <h1 class="  text-2xl sm:text-4xl font-semibold text-red-600 mb-3 hover:text-red-400 transition duration-300"> Choolha Chowka </h1>
  ...
  <ul class="list-disc sm:pl-8 ml-5 sm:ml-0 text-xs">
    ...
    <div class="">
      <h1 class="text-xs sm:text-sm font-semibold text-gray-400 mb-3 mt-5 sm:mt-0">Location</h1>
